...
public class BooleenOrPrim<T, Z> extends BooleenAbs {
	...
	public BooleenOrPrim(Class<T> typeParameterClass1, Class<Z> typeParameterClass2, Object args1, Object args2){
		this.args1 = args1;
		this.args2 = args2;
